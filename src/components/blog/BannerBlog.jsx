    ...
    <div className="w-full h-[856px] bg-black/70 grid justify-center">
      ...
      >
       <div className="flex flex-col justify-end mb-20 mr-48 ">
            ...
            <p className="text-white text-lg">Abitacolo es un ejemplo de que con esfuerzo y colaboración se pueden alcanzar grandes metas. En este blog, queremos compartir nuestra experiencia y conocimientos contigo, además de mostrarte los valores que nos guían.</p>
            </div>
